...
# A list of all recursive dependencies generated by
# apt-rdepends coreutils findutils gawk grep sed make \
#              gcc-arm-linux-gnueabihf g++-arm-linux-gnueabihf\
#              bash cmake python python3 lsb-release perm | grep -v "^ " > dependencies.txt
# Generated on host with
# apt-rdepends packages... | grep -v "^ " > dependencies.txt
# Manually edit to 
#  remove debconf-2.0 and awk
